...
$member = read("SELECT * FROM member WHERE id = $id")[0];
                ...
                <div class="white-box">
                    ...
                    <form method="post" action="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputAddress" name="name" value="<?= $member['name'] ?>" />
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" class="form-control" id="inputPassword4" name="phone" value="<?= $member['phone'] ?>" />
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-8">
                                <label for="inputCity">Address</label>
                                <input type="text" class="form-control" id="inputCity" name="address" value="<?= $member['address'] ?>" />
                            </div>
                            <div class="form-group col-md-4">
                                <label for="inputZip">Post</label>
                                <input type="text" class="form-control" id="inputZip" name="post" value="<?= $member['post'] ?>" />
                            </div>
                        </div>
                        <div class="form-group">
