...
<head>
    ...
    <link href="plugins/bower_components/jquery-datatables/jquery.dataTables.min.css" rel="stylesheet" />
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <b class="logo-icon ml-4">
                            <!-- Dark Logo icon -->
                            <img width="150" src="plugins/images/logo-cashier.png" alt="homepage" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                    ...
                    <ul class="navbar-nav ml-auto d-flex align-items-center">
                        <li>
                            <a class="profile-pic" href="#">
                                <img src="plugins/images/users/5.jpg" alt="user-img" width="36" class="img-circle" /><span class="text-white font-medium"><?= $admin['name'] ?></span></a>
                        </li>
                        <!-- ============================================================== -->
